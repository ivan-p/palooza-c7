...
- (void)acceptConnection:(CFSocketNativeHandle)nativeSocketHandle
{
    ...
    if (readStream && writeStream) {
        ...
        EchoConnection * connection = [[EchoConnection alloc] initWithInputStream:(NSInputStream *)readStream outputStream:(NSOutputStream *)writeStream viewController:vc];
...
- (BOOL)start {
    ...
    self.netService = [[NSNetService alloc] initWithDomain:@"local." type:@"_music._tcp." name:[[UIDevice currentDevice] name] port:(int) self.port];
